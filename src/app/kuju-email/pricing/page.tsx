        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="space-y-8">
            {[
              ...
              {
                q: "Is the SaaS version the same as self-hosted?",
                a: "Yes. The managed SaaS version runs the same Kuju Email software. The difference is that we handle infrastructure, updates, and backups for you.",
              },
              {
                q: "Do I need a separate MTA?",
                a: "No. Kuju Email includes KumoMTA in its embedded deployment mode. Everything you need is included. If you already run KumoMTA, you can also use bolt-on mode to add mailboxes to your existing setup.",
              },
              {
